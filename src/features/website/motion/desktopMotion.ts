...
/** Smooth scroll for desktop app/marketing — binds to `.app-main` scrollport. */
export function useDesktopAppScroll(enabled: boolean) {
  useEffect(() => {
...
/** Marketing alias */
export const useDesktopMarketingScroll = useDesktopAppScroll;
export const useDesktopSmoothScroll = useDesktopAppScroll;
